...
void CP_Rim_remove_by_node_coordinates(CP_Rim*, Carc_Playboard_Location);
...
int CP_rim_transfer_node_update_one_side(CP_Rim*, Carc_Playboard_Node*, Carc_Playboard_Node*, CP_Connect_Side);
